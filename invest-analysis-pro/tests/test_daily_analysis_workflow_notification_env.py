...
def test_notification_actions_env_table_can_be_generated() -> None:
    table = generate_table()

    assert "| Key | Tier | Channel / feature | Actions source | Default |" in table
    assert "`WECHAT_WEBHOOK_URL`" in table
