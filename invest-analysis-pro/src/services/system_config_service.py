...
class SystemConfigService:
    ...
    def test_notification_channel(
        ...
        *,
        ...
        mask_token: str = "******",
        title: str = "invest-analysis-pro 通知测试",
        content: str = "这是一条来自 invest-analysis-pro Web 设置页的通知测试消息。",
    ...
    def import_env(
        ...
        *,
        ...
        return self.update(
            ...
            items=updates,
            mask_token="__INVEST_ANALYSIS_PRO_IMPORT_LITERAL_MASK__",
    ...
    def _build_setup_storage_check(self, effective_map: Dict[str, str]) -> Dict[str, Any]:
        db_path = Path((effective_map.get("DATABASE_PATH") or "./data/invest_analysis_pro.db").strip()).expanduser()
