...
FUNDAMENTAL_STAGE_TIMEOUT_SECONDS_DEFAULT = 20.0
...
class Config:
    ...
    agent_orchestrator_mode: str = "specialist"  # Orchestrator mode: quick/standard/full/specialist
    ...
    email_sender_name: str = "invest-analysis-pro 股票分析助手"  # 发件人显示名称
    ...
    # === 数据库配置 ===
    database_path: str = "./data/invest_analysis_pro.db"
    ...
    # Discord 机器人状态
    discord_bot_status: str = "invest-analysis-pro | /help"
    ...
    def __post_init__(self) -> None:
        ...
        if self.agent_orchestrator_mode not in self._VALID_ORCHESTRATOR_MODES:
            _log.warning(
                "Invalid AGENT_ORCHESTRATOR_MODE=%r, falling back to 'specialist'. Valid: %s",
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            agent_orchestrator_mode=os.getenv('AGENT_ORCHESTRATOR_MODE', 'specialist').lower(),
            ...
            email_sender_name=os.getenv('EMAIL_SENDER_NAME', 'invest-analysis-pro 股票分析助手'),
            ...
            database_path=os.getenv('DATABASE_PATH', './data/invest_analysis_pro.db'),
            ...
            # Discord 机器人扩展配置
            discord_bot_status=os.getenv('DISCORD_BOT_STATUS', 'invest-analysis-pro | /help'),
            # 实时行情增强数据配置
