...
const DESKTOP_VERSION_ARG_PREFIX = '--invest-analysis-pro-desktop-version=';
...
contextBridge.exposeInMainWorld('investAnalysisProDesktop', desktopBridge);
// Backward-compatible bridge name retained for legacy desktop WebUI bundles.
contextBridge.exposeInMainWorld('dsaDesktop', desktopBridge);
