...
const smokePassword = (process.env.INVEST_ANALYSIS_PRO_WEB_SMOKE_PASSWORD || process.env.INVEST_ANALYSIS_PRO_WEB_SMOKE_PASSWORD);

async function login(page: Page) {
  test.skip(!smokePassword, 'Set INVEST_ANALYSIS_PRO_WEB_SMOKE_PASSWORD to run authenticated smoke tests.');
