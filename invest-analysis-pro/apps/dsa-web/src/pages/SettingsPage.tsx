...
type DesktopWindow = Window & {
  investAnalysisProDesktop?: DesktopRuntimeApi;
...
function getDesktopRuntimeApi() {
  ...
  return desktopWindow.investAnalysisProDesktop || desktopWindow.dsaDesktop;
}
...
function formatEnvBackupFilename(isDesktopRuntime: boolean) {
  ...
  return `${isDesktopRuntime ? 'invest-analysis-pro-desktop-env' : 'invest-analysis-pro-env'}_${date}_${time}.env`;
}
...
const SettingsPage: React.FC = () => {
  ...
  // Set page title
  useEffect(() => {
    document.title = '系统设置 - invest-analysis-pro';
  }, []);
