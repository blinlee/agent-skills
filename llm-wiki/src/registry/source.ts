...
import type { RouteProposal } from './registry.js'

export type SourceRole = 'ordinary' | 'source-map'
...
export async function summarizeSource(input: string): Promise<SourceSummary> {
...
export function inferRegistrySourceRole(filePath: string, content: string): SourceRole {
