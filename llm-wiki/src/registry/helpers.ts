...
import type { WikiRegistryEntry } from './registry.js'
...
export async function ensureTextFile(filePath: string, initialValue: string): Promise<void> {
...
function extractSearchTokens(token: string): string[] {
...
export function normalizeWikiProfile(wiki: WikiRegistryEntry): WikiRegistryEntry {
...
export function defaultGranularityPolicy(): WikiRegistryEntry['granularity'] {
  return {
