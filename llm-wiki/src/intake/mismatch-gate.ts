...
export type SourceMismatchSignal = {
...
export function detectSourceMetadataMismatch(artifact: ParsedArtifact): SourceMismatchSignal | null {
...
function sourceHintFromRef(sourceRef: string): string {
