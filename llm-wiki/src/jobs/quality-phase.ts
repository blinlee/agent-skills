...
import {
  ...
  type ValidatedInboxQualityPlan,
} from '../intake/quality-gate.js'
import type { SourceKind } from '../types.js'

export type InboxQualityPhaseResult =
  | { status: 'ready'; qualityPlan: ValidatedInboxQualityPlan }
  | { status: 'needs_review'; reviewFiles: string[]; details: Record<string, unknown> }
...
export async function runInboxQualityPhase(input: {
...
}): Promise<InboxQualityPhaseResult> {
  ...
  let qualityPlan: ValidatedInboxQualityPlan
  try {
