...
function buildDefaultWikiSchema() {
    return [
        ...
        '',
        '## Page thresholds',
        '- Create a durable entity/concept page only after the candidate is accepted; centrality and repeated evidence justify a proposal, not silent materialization.',
        ...
        '- Route candidate, uncertain, conflicting, or merge-prone knowledge to review instead of hardening it silently.',
        '- New evidence for an already accepted topic should enter taxonomy evidence proposals first; do not silently mutate accepted concept pages from new ingest.',
        '',
