...
export async function exportOkfBundle(input) {
...
async function prepareOutputDirectory(knowledgeRoot, outputDir) {
...
async function copyPageLogFile(input) {
...
async function writeOkfIndexes(outputDir, concepts, generatedAt) {
...
function firstSource(frontmatter) {
...
function defaultTypeForSection(section) {
