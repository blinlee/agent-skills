...
适用于“人物或产品从手机 / 社媒卡片里冲出来”的高冲击封面，常见于小红书、X、品牌社媒广告与创作者主页宣传图。
...
{
  "type": "社媒破屏广告封面",
  "platform": "{argument name=\"platform\" default=\"小红书 / X / 通用社媒广告\"}",
  "subject": {
    "description": "{argument name=\"subject\" default=\"时尚感极强的年轻女性或品牌主理人\"}",
    "pose": "{argument name=\"pose\" default=\"从手机屏幕中跨步而出，一只脚朝向镜头形成强透视\"}"
  },
  "screen_shell": {
    "type": "{argument name=\"screen shell\" default=\"透明玻璃手机 / 社媒主页卡片\"}",
    "content": "{argument name=\"screen content\" default=\"真实感社媒帖子 UI、头像、点赞评论分享图标\"}"
  },
  "effects": {
    "breakthrough": "玻璃裂纹 + 数字碎片 + 发光粒子沿主体运动方向爆发",
    "icons": "少量漂浮互动图标，必须与平台气质一致"
  },
  "style": {
    "color_palette": "{argument name=\"color palette\" default=\"暖米色 + 柔粉 + 金色 / 平台品牌色\"}",
    "rendering": "超现实 3D + 半写实商业广告质感"
  },
  "constraints": {
    "must_keep": [
      "主体姿势和透视必须形成强冲出感",
      "手机 / 社媒壳体必须清晰可辨",
      "平台 UI 图标数量克制，不要变成杂乱信息墙"
    ],
    "avoid": [
      "主体像漂浮在屏幕前而不是冲破屏幕",
      "粒子和裂纹遮住主体脸部",
...
**社媒破屏商业广告（2 条）**
> - "动态的豪华商业广告海报，特色是超现实3D渲染的年轻女性从巨大的金色智能手机屏幕中爆发而出，带 X / Twitter 广告氛围。"
> - "将一位气质极佳的女孩放置在显示小红书帖文的 3D 透明玻璃手机画面中，使她像正从屏幕中突破进入现实世界。"
> 要点：这类素材本质是“封面级社媒广告视觉”，不是帖子详情页，也不一定真的是视频缩略图。重点是强透视、数字破屏、平台 icon 点缀和高冲击商业感，适合吸收到本模板的高点击封面 / hero 视觉分支，而不是硬塞进社媒帖子模板。
