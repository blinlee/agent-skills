...
**真实犯罪调查拼贴**
> Prompt: "A YouTube thumbnail-style collage for a dark, dramatic, true crime investigation. In the center is a highly detailed, close-up portrait of an older man... with a faint red glowing outline... On the left side, a tropical island with luxury villas... a conspiracy board motif with exactly 2 red push pins connected by 3 thick red strings... an open manila folder containing a heavily redacted dossier..."
> 要点：犯罪调查类缩略图的视觉语言是：暗色调、红色高亮轮廓、阴谋板（钉子+线）、涂黑文件。构图是中心人物+四周散落的线索元素。
