...
**日本 Webinar 缩略图**
> Prompt: "日本のよくある高品質なウェビナーサムネイルを作成して。16:9横長。文字は多いが、メインコピーがしっかり目立っている。"
> 要点：日式 Webinar 缩略图的特点是文字密度极高但主次分明。主标题必须最大最醒目，其余信息按层级递减。

**YouTube 开箱缩略图**
> Prompt: "youtubeの開封動画のサムネイル、滞納した請求書全部開封しますの動画、100連"
> 要点：开箱类缩略图需要展示"待开箱物品的堆积感"+夸张数量（100连）。幽默感和好奇心是核心卖点。
