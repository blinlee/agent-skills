...
**Gold & Black 信息产品封面**
> Prompt: A JSON template for a "promotional banner / YouTube thumbnail" with gold and black palette, featuring a confident young Asian man in a dark suit, glowing laptop, 3D gold typography for "AI副業 完全攻略", multiple structured text callouts and badges.
> 要点：信息产品封面是 YouTube 缩略图的高频类型。特点是文字密度极高、金/黑/霓虹配色、多层 badge + 标签。

**VTuber 直播封面（5+ 条）**
> Prompt: An anime-style YouTube stream thumbnail featuring a cheerful female VTuber with pink hair, cat-ear headphones, bold pop-art Japanese typography reading "雑談" and "配信", red LIVE badge, floating speech bubbles, stars and hearts.
> 要点：VTuber 直播封面是 YouTube 缩略图的高频类型。特点是：动漫角色 + 大字标题 + LIVE 徽章 + 粉/紫霓虹配色。注意文字必须可读（日文/中文），角色表情和姿态要与直播主题匹配。
...
- Associated template IDs: `poster-layout-system`, `sports-campaign-poster`
- Retrieval styles: `Poster`, `Realistic`
- Retrieval scenes: `Commerce`, `Social`, `Fashion`
- Curated example cases: `345`, `5`, `10`, `350`, `3`
