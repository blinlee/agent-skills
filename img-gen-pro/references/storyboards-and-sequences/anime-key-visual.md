...
适用于“像某台经典主机时代的游戏封面 / 宣发海报”的单图主视觉。重点是封面完成度、年代气质、标题和角色同场成立，而不是 HUD 或实机截图。
...
{
  "type": "复古主机游戏封面 KV",
  "franchise_vibe": "{argument name=\"console era\" default=\"Super Famicom / PS1 / Dreamcast 时代\"}",
  "title_block": {
    "main_title": "{argument name=\"main title\" default=\"小恶魔莉莉香\"}",
    "sub_title": "{argument name=\"sub title\" default=\"如果它是一款 90 年代主机游戏\"}",
    "position": "顶部或左上封面区，保留真实封面感"
  },
  "characters": {
    "count": "{argument name=\"character count\" default=\"1-3\"}",
    "items": ["{argument name=\"character 1\" default=\"恶魔系少女主角，夸张表情，强识别 silhouette\"}"]
  },
  "world": {
    "scene": "{argument name=\"scene\" default=\"像 16-bit / 32-bit 时代 RPG / action game 封面的奇幻场景\"}",
    "atmosphere": "怀旧、夸张、封面式叙事"
  },
  "constraints": {
    "must_keep": [
      "看起来像真实游戏封面而非现代短视频封面",
...
**复古主机游戏封面感（1 条）**
> - "Think of a poster when the little devil Lilim Lily-chan was a Super Famicom game."
> 要点：这种 case 的重点不是系统 UI，而是“像那个年代真的会卖的一张游戏封面”。因此应吸收到 anime KV 的复古主机封面变体，而不是放进游戏截图模板。
