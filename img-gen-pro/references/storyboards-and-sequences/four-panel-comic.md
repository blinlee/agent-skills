...
适用于用户提供一张参考照片（团队合照、旅行照、自拍等），要求将其转化为四格漫画风格。
...
{
  "type": "参考图转四格漫画",
  "goal": "根据用户提供的照片，提取人物特征和场景，生成一张四格漫画",
  "reference_image": "用户提供的人物/场景照片",
  "extraction": {
    "characters": "从照片中提取人物外貌、服装、姿态特征",
    "scene": "从照片中提取场景元素和氛围",
    "mood": "从照片中提取人物表情和情绪"
  },
  "story": {
    "mode": "{argument name=\"story mode\" default=\"自动根据照片内容编一个起承转合的小故事\"}",
    "user_override": "{argument name=\"custom story\" default=\"\"}"
  },
  "style": {
    "art_style": "{argument name=\"art style\" default=\"日漫线稿 + 平涂淡色\"}",
    "consistency": "漫画人物必须与照片中的人物特征对应"
  },
  "constraints": {
    "must_keep": [
      "漫画人物特征与照片一致（发型、服装、体型）",
      "四格故事与照片场景有逻辑关联",
      "画风统一"
    ],
    "avoid": [
