...
**收藏级玩具 / 游戏角色周边发布板（1 条）**
> - "Design a collector-grade launch visual for famous scientists as toys, with interchangeable accessories, alternate expressions, packaging design, rarity indicators, and close-up material highlights."
> 要点：虽然原 case 是科学家玩具，但它本质上是“角色 IP × 周边 × 稀有度 × 包装”的 merch board 逻辑。对游戏资产来说，这类案例非常适合承接角色周边、限定版、收藏级首发视觉，不需要新建‘游戏周边类别’。

### 吸收规则（游戏资产衍生物）

- 角色 × 周边 × 包装 × 稀有度 × 上新公告 → 吸收到本模板
- 如果重点只是单个玩具 hero shot → 改走 `collectible-figure-display.md`
- 如果重点只是角色设定而没有商品生态 → 改走 `character-sheet.md`
