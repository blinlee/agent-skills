...
**游戏立项 / 稀有卡体系整合板（1 条）**
> - "为中国古代诗人设计一套游戏卡片，并按照 SSR / SR / R 分级，重点卡片有放大展示效果，包括卡面设计、人物介绍、技能设计与套卡说明。"
> 要点：当一张图里既要展示角色卡面，又要展示稀有度、技能、套卡逻辑时，这已经不是单张 KV，而是 pitch board / system board。适合吸收到本模板的“游戏立项 pitch”变体里。

### 吸收规则（游戏资产整合板）

- 需要“一张图讲完作品 / 玩法 / 角色 / 世界观 / 卡牌系统” → 吸收到本模板
- 只有单张主视觉、封面、卡面 hero shot → 改走 `anime-key-visual.md`
- 只有角色设定 / 三视图 / 动作库 → 改走 `character-sheet.md`
- 只有实机 screenshot / HUD → 改走 `game-screenshot-mockup.md`
