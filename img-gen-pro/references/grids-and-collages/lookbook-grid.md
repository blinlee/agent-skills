...
> - "治愈系助眠指南九宫格"
> - "春日花田三联竖版写真拼贴"
> 要点：这类素材虽然也在社交平台传播，但核心不是单条帖子 UI，而是“同一主题的多 panel 合集”。适合吸收到 lookbook / 清单 / 九宫格信息图，而不是错误归进社媒详情页模板。

### 吸收规则（社交媒体多格合集）

- 同一主题的九宫格、三联图、系列写真、清单式合集 → 留在本模板
- 如果每格本质都是不同广告 banner → 改走 `ad-banner-multi-grid.md`
- 如果重点是单条动态 UI 或评论区 → 改走 `social-interface-mockup.md`
