...
**AI 模型技术信息图（2 条）**
> Prompt: A JSON template for a "highly dense futuristic tech infographic board" with gold and deep blue colors, dark mode, glowing neon borders, complex mind-map layout. Includes: center golden emblem reading "GPT-Image-2", 4 leak image panels, 5 use case panels, 3 version comparison panels, 4 core feature nodes, technical specs, a 3-column model comparison table, future outlook, and a 10-image style gallery strip.
> 要点：超高密度技术信息图是 YouTube 科技频道的常见缩略图类型。特点是：mind-map 布局、发光边框、深色背景、信息量极大但视觉上有序。适合展示 AI 模型对比、技术特性概览等。
...
- Associated template IDs: `infographic-engine`, `scientific-scale-diagram`
- Retrieval styles: `Infographic`, `Charts`, `Realistic`
- Retrieval scenes: `Education`, `Tech`
- Curated example cases: `334`, `1`, `8`, `341`
